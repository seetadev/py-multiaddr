...
BYTES_MAP_STR_TEST_DATA = [
    ...
    ("/ip4/127.0.0.1/udp/1234/ip4/127.0.0.1/tcp/4321", b"\x04\x7f\x00\x00\x01\x91\x02\x04\xd2\x04\x7f\x00\x00\x01\x06\x10\xe1"),
]
...
@pytest.mark.parametrize(
    "proto, buf, expected", ADDR_BYTES_STR_TEST_DATA + ADDR_BYTES_TO_STR_TEST_DATA
)
...
@pytest.mark.parametrize(
    "proto, expected, string", ADDR_BYTES_STR_TEST_DATA + ADDR_BYTES_FROM_STR_TEST_DATA
)
